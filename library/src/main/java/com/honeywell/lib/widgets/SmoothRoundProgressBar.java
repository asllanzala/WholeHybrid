...
public class SmoothRoundProgressBar extends View {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        try {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.SmoothRoundProgressBar);
            strokeWidth = (int) typedArray.getDimension(R.styleable.SmoothRoundProgressBar_cpb_strokeWidth, strokeWidth);
            startColor = typedArray.getColor(R.styleable.SmoothRoundProgressBar_cpb_startColor, startColor);
            endColor = typedArray.getColor(R.styleable.SmoothRoundProgressBar_cpb_endColor, endColor);
            duration = typedArray.getInteger(R.styleable.SmoothRoundProgressBar_cpb_duration, duration);
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
            }
