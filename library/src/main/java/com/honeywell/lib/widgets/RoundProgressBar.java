...
/**
 * Created by milton_lin on 17/4/11.
 */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (style) {
            case STROKE: {
                ...
                canvas.drawArc(oval, START_ANGLE, 360 * progress / max, false, paint);  //根据进度画圆弧
                break;
            }
            case FILL: {
                paint.setStyle(Paint.Style.FILL_AND_STROKE);
                if (progress != 0)
                    canvas.drawArc(oval, START_ANGLE, 360 * progress / max, true, paint);  //根据进度画圆弧
                break;
            }
        }
