...
public class PercentLinearLayout extends LinearLayout {
    ...
    private static final String TAG = PercentLinearLayout.class.getSimpleName();
...
//        LogUtil.e("aaaa", "PercentLinearLayout getMeasuredWidth() = " + widthSize + " , getMeasuredHeight() = " + heightSize, true);
