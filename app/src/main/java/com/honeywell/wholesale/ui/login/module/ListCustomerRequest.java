...
public class ListCustomerRequest {
    ...
    public ListCustomerRequest(String mShopId, String lastUpdateTime) {
        this.mShopId = mShopId;
        this.lastUpdateTime = lastUpdateTime;
    }

    public ListCustomerRequest(String mShopId, String lastUpdateTime, String mUntilTime) {
        this.mShopId = mShopId;
        this.lastUpdateTime = lastUpdateTime;
        this.mUntilTime = mUntilTime;
    }

    public ListCustomerRequest(String mShopId, String lastUpdateTime, String mUntilTime, String mSearchKey) {
        this.mShopId = mShopId;
        this.lastUpdateTime = lastUpdateTime;
        this.mUntilTime = mUntilTime;
