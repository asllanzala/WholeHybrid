...
public class SaleReturnOrderRequest {
    ...
    public SaleReturnOrderRequest() {
    }

    public SaleReturnOrderRequest(int shopId, String totalPrice, String customerName, int customerId, String remark) {
        this.shopId = shopId;
    ...
    public SaleReturnOrderRequest(int shopId, String totalPrice, String customerName, int customerId) {
        this.shopId = shopId;
        this.totalPrice = totalPrice;
        this.customerName = customerName;
        this.customerId = customerId;
    ...
    public SaleReturnOrderRequest(int shopId, String totalPrice, String customerName, String address,
    ...
    public static class SaleSku{
        ...
        public SaleSku(int inventoryId, String standardPrice, String quantity) {
            this.inventoryId = inventoryId;
            this.standardPrice = standardPrice;
            this.quantity = quantity;
        }

        public SaleSku(int inventoryId, String standardPrice, String quantity, ArrayList<WarehouseSku> warehouseSkuList) {
            this.inventoryId = inventoryId;
            this.standardPrice = standardPrice;
            this.quantity = quantity;
