...
import com.honeywell.wholesale.ui.saleReturn.adapter.PreSaleReturnSearchAdapter;
...
public class PreSaleReturnSearchActivity extends BaseActivity {

    private static final String TAG = PreSaleReturnSearchActivity.class.getSimpleName();
    ...
    private PreSaleReturnSearchAdapter preSaleReturnSearchAdapter;
...
//        initialSearch(editText.getText().toString());
    ...
    protected void onResume() {
        super.onResume();
        setBottomShow();
        if (preSaleReturnSearchAdapter != null) {
            preSaleReturnSearchAdapter.notifyDataSetChanged();
        }
    }
    ...
    public void onEventMainThread(PreCartToCartEvent event) {
        ...
        PreSaleReturnSearchActivity.this.finish();//收到订阅事件之后关闭当前界面
    }
    ...
    private void initialView() {
        ...
        totalInfoLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PreSaleReturnSearchActivity.this, PreTransactionCartActivity.class);
        ...
        preSaleReturnSearchAdapter = new PreSaleReturnSearchAdapter(this);

        resultListView = (ListView) findViewById(R.id.pre_search_result_list);
        resultListView.setAdapter(preSaleReturnSearchAdapter);
        resultListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(), PreSaleReturnSkuSelectActicity.class);
        ...
        webClient.httpGetInventories(preOrderSearchRequest, new NativeJsonResponseListener<JSONObject>() {
            ...
            public void listener(JSONObject jsonObject) {
                if (jsonObject != null) {
                    ...
                    preSaleReturnSearchAdapter.setDataSource(arrayList, wareHouseId);
                    preSaleReturnSearchAdapter.notifyDataSetChanged();
