...
public class AddCustomerActivity extends CommonWebViewActivity {

    public static final String TAG = AddCustomerActivity.class.getSimpleName();
    public static final int REQUEST_CODE_CUSTOMER_IMAGES_UPLOAD = 101;

    @Override
    public String getUrl() {
        return H5PageURL.URL_CUSTOMER_ADD;
    }
...
//                                            REQUEST_CODE_CUSTOMER_IMAGES_UPLOAD);
//                                } else {
...
//        switch (requestCode) {
//            case REQUEST_CODE_CUSTOMER_IMAGES_UPLOAD:
