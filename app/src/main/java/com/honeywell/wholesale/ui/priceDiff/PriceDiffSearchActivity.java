...
import com.honeywell.wholesale.ui.priceDiff.adapter.PriceDiffSearchAdapter;
...
public class PriceDiffSearchActivity extends BaseActivity {

    private static final String TAG = PriceDiffSearchActivity.class.getSimpleName();
    ...
    private PriceDiffSearchAdapter priceDiffSearchAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_price_diff_search);
        initialData();
        initialView();
...
//        initialSearch(editText.getText().toString());
    ...
    protected void onResume() {
        super.onResume();
        setBottomShow();
        if (priceDiffSearchAdapter != null) {
            priceDiffSearchAdapter.notifyDataSetChanged();
        }
    }
    ...
    public void onEventMainThread(PreCartToCartEvent event) {
        ...
        PriceDiffSearchActivity.this.finish();//收到订阅事件之后关闭当前界面
    }
    ...
    private void initialView() {
        ...
        totalInfoLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PriceDiffSearchActivity.this, PreTransactionCartActivity.class);
        ...
        priceDiffSearchAdapter = new PriceDiffSearchAdapter(this);

        resultListView = (ListView) findViewById(R.id.pre_search_result_list);
        resultListView.setAdapter(priceDiffSearchAdapter);
        resultListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getApplicationContext(), PriceDiffSkuSelectActicity.class);
        ...
        webClient.httpGetInventories(preOrderSearchRequest, new NativeJsonResponseListener<JSONObject>() {
            ...
            public void listener(JSONObject jsonObject) {
                if (jsonObject != null) {
                    ...
                    priceDiffSearchAdapter.setDataSource(arrayList, wareHouseId);
                    priceDiffSearchAdapter.notifyDataSetChanged();
