...
public class PurchaseOrderConfirmActivity extends BaseActivity {
    ...
    private BaseTextView supplierContentTextView;
    ...
    public static PurchaseOrderConfirmActivity purchaseOrderConfirmActivity;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_purchase_order_confirm);
        EventBus.getDefault().register(this);
        purchaseOrderConfirmActivity = this;
        initData();
        initView();
    ...
    private void initView() {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (actualMoneyContentEditText.getText().toString().equals("")){
                    ...
                    Intent intent = new Intent(PurchaseOrderConfirmActivity.this, PurchasePaySelectActivity.class);
        ...
        actualMoneyContentEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                BigDecimal totalMoney = new BigDecimal(cartModel.getTotalMoneyByStock());
        ...
        supplierContentTextView = (BaseTextView) findViewById(R.id.supplier_content_text_view);
        ...
        titleTextView.setText("采购单确认");
        supplierContentTextView.setText(cartModel.getSupplierName());
    ...
    private void addProductTitleView(final PreCart preCart) {
        final View child = getLayoutInflater().inflate(R.layout.item_purchase_confirm_title, null);
    ...
    private void addProductSubView(final PreCart preCart, final SKU sku) {
        final View child = getLayoutInflater().inflate(R.layout.item_purchase_confirm, null);
        setViewTag(child, preCart, sku);
        productContainerSection.addView(child);
        final BaseTextView countEditText = (BaseTextView) child.findViewById(R.id.product_no_text_view);
        final BaseTextView batchBatchTextView = (BaseTextView) child.findViewById(R.id.batch_content_text_view);
        batchBatchTextView.setText(sku.getBatchName());
